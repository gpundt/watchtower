...
SRC_AGENT_CERT=../certs/"$AGENT_HOSTNAME"_agent/agent.crt
DST_AGENT_CERT=$TLS_DIRECTORY/"$AGENT_HOSTNAME"_agent/agent.crt
SRC_AGENT_KEY=../certs/"$AGENT_HOSTNAME"_agent/agent.key
DST_AGENT_KEY=$TLS_DIRECTORY/"$AGENT_HOSTNAME"_agent/agent.key
...
function prep_important_dirs() {
    ...
    _create_dir $TLS_DIRECTORY/"$AGENT_HOSTNAME"_agent
